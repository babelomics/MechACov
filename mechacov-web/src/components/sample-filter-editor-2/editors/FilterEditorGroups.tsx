...
const mapStateToProps = (state: any) => ({
    values: (state.sampleFilter.groups || []) as string[],
});


const mapDispatchToProps = (dispatch: any) => ({
    resetValues: () => { dispatch(SampleFilterActions.resetGroups()); },
    addValue: (value: string) => { dispatch(SampleFilterActions.addGroup(value)); },
    removeValue: (value: string) => { dispatch(SampleFilterActions.removeGroup(value)); },
});
