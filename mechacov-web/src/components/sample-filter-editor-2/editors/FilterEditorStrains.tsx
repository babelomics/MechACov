...
class Component extends React.PureComponent<ComponentProps, ComponentState> {
    ...
    private readonly fetchAllValues = async () => {
        ...
        MechACovClient.getStrains(this.abortController.signal).then((values: string[]) => {
...
const mapStateToProps = (state: any) => ({
    values: (state.sampleFilter.strains || []) as string[],
});


const mapDispatchToProps = (dispatch: any) => ({
    resetValues: () => { dispatch(SampleFilterActions.resetStrains()); },
    addValue: (value: string) => { dispatch(SampleFilterActions.addStrain(value)); },
    removeValue: (value: string) => { dispatch(SampleFilterActions.removeStrain(value)); },
