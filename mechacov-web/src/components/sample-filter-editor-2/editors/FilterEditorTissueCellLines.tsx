...
class Component extends React.PureComponent<ComponentProps, ComponentState> {
        ...
        return (
            <Accordion expanded={open} onChange={this.handleToggle}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                    <Typography>TissueCellLines</Typography>
                </AccordionSummary>
                <AccordionDetails>
    ...
    private readonly fetchAllValues = async () => {
        ...
        MechACovClient.getTissueCellLines(this.abortController.signal).then((values: string[]) => {
...
const mapStateToProps = (state: any) => ({
    values: (state.sampleFilter.tissueCellLines || []) as string[],
});


const mapDispatchToProps = (dispatch: any) => ({
    resetValues: () => { dispatch(SampleFilterActions.resetTissueCellLines()); },
    addValue: (value: string) => { dispatch(SampleFilterActions.addTissueCellLine(value)); },
    removeValue: (value: string) => { dispatch(SampleFilterActions.removeTissueCellLine(value)); },
