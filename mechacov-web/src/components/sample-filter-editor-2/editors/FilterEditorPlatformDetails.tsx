...
class Component extends React.PureComponent<ComponentProps, ComponentState> {
        ...
        return (
            <Accordion expanded={open} onChange={this.handleToggle}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                    <Typography>Platform details</Typography>
                </AccordionSummary>
                <AccordionDetails>
    ...
    private readonly fetchAllValues = async () => {
        ...
        const studies = MechACovClient.getPlatformDetails(this.abortController.signal).then((values: string[]) => {
...
const mapStateToProps = (state: any) => ({
    values: (state.sampleFilter.platformDetails || []) as string[],
});


const mapDispatchToProps = (dispatch: any) => ({
    resetValues: () => { dispatch(SampleFilterActions.resetPlatformDetails()); },
    addValue: (value: string) => { dispatch(SampleFilterActions.addPlatformDetail(value)); },
    removeValue: (value: string) => { dispatch(SampleFilterActions.removePlatformDetail(value)); },
